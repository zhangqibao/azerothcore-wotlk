...
enum WorldBoolConfigs
{
    ...
    CONFIG_BOOL_PVPDROPITEM_ENABLE,
    CONFIG_BOOL_RAID_DIFFICULT_ENABLE,
    CONFIG_BOOL_RANDOMFM,
    CONFIG_BOOL_REBORN_START_CHALLENGE_ENABLE,
    CONFIG_BOOL_PROFESSOR_DEAD_TO_NORMAL_ENABLE,
    CONFIG_BOOL_CHALLENGE_ARTMODE_ENABLE,
    CONFIG_BOOL_FS_LEVELPENALTY_ENABLE,
    CONFIG_BOOL_ITEMUSEINBG_ENABLE,
    CONFIG_BOOL_ITEMUSEINARENA_ENABLE,
    CONFIG_BOOL_STARTGUILD_ENABLE,
...
enum WorldIntConfigs
{
    ...
    CONFIG_AHBOT_AH_ID,
    CONFIG_AHBOT_AH_FID,
    CONFIG_AHBOT_ITEMCOUNT,
    CONFIG_AHBOT_BOT_GUID,
    CONFIG_AHBOT_ACCOUNT,
    ...
    CONFIG_UINT32_EARNXP_MAX_PLAYER_LEVEL,
    CONFIG_UINT32_TRANSMODCARD_ADD_STAT,
    CONFIG_UINT32_FACTIONCARD_ADD_STAT,
    CONFIG_UINT32_PVP_FORBID_LEVEL_DIFF,
    CONFIG_UINT32_PVP_FORBID_LEVEL_MIX,

    CONFIG_UINT32_STARTGUILD_BL,
    CONFIG_UINT32_STARTGUILD_LM,

    CONFIG_WOWPATCH,//阶段配置项
...
enum Rates
{
    ...
    //新增配置项
    CONFIG_FLOAT_YH_RATE_INTELLECT,
    CONFIG_FLOAT_RATE_CREATURE_RAID_NORMAL_DAMAGE,
    CONFIG_FLOAT_RATE_CREATURE_RAID_ELITE_ELITE_DAMAGE,
    CONFIG_FLOAT_RATE_CREATURE_RAID_ELITE_RAREELITE_DAMAGE,
    CONFIG_FLOAT_RATE_CREATURE_RAID_ELITE_BOSS_DAMAGE,
    CONFIG_FLOAT_RATE_CREATURE_RAID_ELITE_RARE_DAMAGE,
    CONFIG_FLOAT_RATE_CREATURE_RAID_NORMAL_SPELLDAMAGE,
    CONFIG_FLOAT_RATE_CREATURE_RAID_ELITE_ELITE_SPELLDAMAGE,
    CONFIG_FLOAT_RATE_CREATURE_RAID_ELITE_RAREELITE_SPELLDAMAGE,
    CONFIG_FLOAT_RATE_CREATURE_RAID_ELITE_BOSS_SPELLDAMAGE,
    CONFIG_FLOAT_RATE_CREATURE_RAID_ELITE_RARE_SPELLDAMAGE,
    CONFIG_FLOAT_RATE_CREATURE_RAID_NORMAL_HP,
    CONFIG_FLOAT_RATE_CREATURE_RAID_ELITE_ELITE_HP,
    CONFIG_FLOAT_RATE_CREATURE_RAID_ELITE_RAREELITE_HP,
    CONFIG_FLOAT_RATE_CREATURE_RAID_ELITE_BOSS_HP,
    CONFIG_FLOAT_RATE_CREATURE_RAID_ELITE_RARE_HP,

    CONFIG_FLOAT_YH_XP_RATE,
    CONFIG_FLOAT_SPELL_LEARN_COST,
    CONFIG_FLOAT_SPELL_LEARN_COST_SPECIALNPC,
    CONFIG_FLOAT_REBORN_GET_STATS_RATE,
    CONFIG_FLOAT_REBORN_GET_STATS_RATE_PET,
    CONFIG_FLOAT_PVE_PERLEVEL_DAMAGE,
    CONFIG_FLOAT_PVE_PERLEVEL_UNDAMAGE,

    CONFIG_FLOAT_RATE_XP_REWARD_MULTIPLY,
    CONFIG_FLOAT_RATE_XP_REWARD_MAXLEVEL,
    CONFIG_FLOAT_RATE_XP_REWARD_CAMPLM,
    CONFIG_FLOAT_RATE_XP_REWARD_CAMPBL,
    CONFIG_FLOAT_RATE_XP_REWARD_CLASS_WARRIOR,
    CONFIG_FLOAT_RATE_XP_REWARD_CLASS_PALADIN,
    CONFIG_FLOAT_RATE_XP_REWARD_CLASS_SHAMAN,
    CONFIG_FLOAT_RATE_XP_REWARD_CLASS_PRIEST,
    CONFIG_FLOAT_RATE_XP_REWARD_CLASS_DRUID,
    CONFIG_FLOAT_RATE_XP_REWARD_CLASS_HUNTER,
    CONFIG_FLOAT_RATE_XP_REWARD_CLASS_MAGE,
    CONFIG_FLOAT_RATE_XP_REWARD_CLASS_WARLOCK,
    CONFIG_FLOAT_RATE_XP_REWARD_CLASS_ROGUE,
    CONFIG_FLOAT_RATE_XP_REWARD_CLASS_DEATH_KNIGHT,
